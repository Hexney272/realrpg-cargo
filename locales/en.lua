...
Locales['en'] = {
    ...
    ['add_money'] = 'You received %s Ft! (%s)',
    ['add_society_money'] = 'Defender faction: %s received their payment: %s Ft!',
    ['remove_money'] = '%s Ft paid!',
    ...
    -- ACHIEVEMENTS
    ['achievement_first_delivery'] = 'First Delivery',
    ['achievement_first_delivery_desc'] = 'Complete your first cargo delivery',
    ['achievement_road_warrior'] = 'Road Warrior',
    ['achievement_road_warrior_desc'] = 'Drive 500 km total distance',
    ['achievement_marathon_runner'] = 'Marathon Runner',
    ['achievement_marathon_runner_desc'] = 'Drive 2000 km total distance',
    ['achievement_perfectionist'] = 'Perfectionist',
    ['achievement_perfectionist_desc'] = 'Maintain 98%+ quality rate over 10+ deliveries',
    ['achievement_veteran'] = 'Veteran',
    ['achievement_veteran_desc'] = 'Complete 100 deliveries',
    ['achievement_mission_specialist'] = 'Mission Specialist',
    ['achievement_mission_specialist_desc'] = 'Complete 20 mission deliveries',
    ['achievement_guardian'] = 'Guardian',
    ['achievement_guardian_desc'] = 'Defend 10 missions as a protector',
    ['achievement_danger_lover'] = 'Danger Lover',
    ['achievement_danger_lover_desc'] = 'Complete 50 vulnerable cargo deliveries',
    ['achievement_ironman'] = 'Ironman',
    ['achievement_ironman_desc'] = 'Accumulate 10 hours of working time',
    ['achievement_thief'] = 'Thief',
    ['achievement_thief_desc'] = 'Steal 5 cargo shipments',
    ['achievement_legend'] = 'Legend',
    ['achievement_legend_desc'] = 'Drive 10000 km and complete 500 deliveries',
}
